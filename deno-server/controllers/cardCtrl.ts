import * as cardService from '../dao/card-service.ts';

async function addCard(req: any, res: any) {
...
async function getCardsByMatchId(req: any, res: any) {
  let userId = req.user.id;
...
async function deleteCard(req: any, res: any) {
  let userId = req.user.id;
