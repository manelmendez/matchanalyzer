...
function addNoManagerTeam(req: any, res: any) {  
  let userId = req.user.id;
  let team = {
    name: req.body.name,
    season: req.body.season,
...
function getTeam(req: any, res: any) {
  let userId = req.user.id;
  let teamId = req.params.id;
  console.log("Buscando equipo con id: " + teamId + " en la base de datos...");
  //search team on DB
  teamService.findById(teamId, userId).then((team: any) => {
    if (team) {      
...
// function getAllTeams(req: any, res: any) {
//   console.log("Buscando todos los equipos en la base de datos...");
//   teamService.findAll().then((teams: any) => {
...
function getUserTeams(req: any, res: any) {
...
function updateTeam(req: any, res: any) {
...
function deleteTeam (req: any, res: any) {
  let teamId = req.params.id;  
  let userId = req.user.id;
...
function getTeamStats(req: any, res: any) {
  ...
  roundService.findByCompetition(competitionId, userId).then((value => {          
    ...
    matchService.findByCompetition(competitionId, userId).then(((matches: any) => {
      teamService.findByCompetition(competitionId, userId).then(((teams: any) => {
