...
export class RoundController {
  ...
  addRound = async (req: Request, res: Response, next: NextFunction) => {
    try {
      if (!req.user) {
  ...
  deleteRound = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  getCompetitionRounds = async (req: Request, res: Response, next: NextFunction) => {
    try {
